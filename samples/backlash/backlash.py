"""
Mask R-CNN
Train on the Backlash policemen dataset
...
class PoliceDataset(utils.Dataset):

    def load_data(self, dataset_dir, subset, filename="via_region_data.json"):
        """Load a subset of the Police dataset.
...
def train(model):
    """Train the model."""
    # Training dataset.
    dataset_train = PoliceDataset()
    dataset_train.load_data(args.dataset, "train", "via_region_data.json")
    dataset_train.prepare()

    # Validation dataset
    dataset_val = PoliceDataset()
    dataset_val.load_data(args.dataset, "val", "via_region_data.json")
    dataset_val.prepare()
...
# customize to make static log dir 
# for tensorboard in colab
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description='Train Mask R-CNN to detect policemen.')
    parser.add_argument("command",
                        metavar="<command>",
                        help="'train' or 'splash'")
    parser.add_argument('--dataset', required=False,
                        metavar="../../datasets/police2",
                        help='Directory of the Policemen dataset')
    ...
    if args.command == "train":
        ...
        class InferenceConfig(PoliceConfig):
